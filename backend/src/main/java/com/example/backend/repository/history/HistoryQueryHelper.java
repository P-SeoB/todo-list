...
import com.example.backend.controller.history.dto.HistoryReadDto;
...
public class HistoryQueryHelper {
    ...
    public RowMapper<HistoryReadDto> getMapper() {
        return mapper;
    }

    private static final RowMapper<HistoryReadDto> mapper = (rs, rowNum) ->
            new HistoryReadDto(
                    rs.getLong(ID),
